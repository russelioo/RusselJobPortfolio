...
const projects = [
    {
        ...
        highlights: [
            'Served as Project Manager — led planning, coordination, and documentation.',
            'Developed the front-end interface using Vue 3, Inertia.js, and Tailwind CSS.',
    ...
    },
    {
        ...
        role: 'IT / System Development · Front-End Development',
        ...
        highlights: [
            ...
            'Front-end development and IT system support role.',
